...
//typedef struct __GHashTable vartable;
//GHashTable* vartable = g_hash_table_new(NULL,NULL);
int offset = 0;
...
//		g_hash_table_insert(vartable,&t,&offset);
